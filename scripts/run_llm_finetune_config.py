"""Launch an LLM fine-tuning sweep from a tracked YAML config."""
...
from experiments.llm_finetune.sweep import main as sweep_main
from residual_clipping.configs import config_to_argv, load_yaml_config


def build_config_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a tracked LLM fine-tuning sweep config.")
