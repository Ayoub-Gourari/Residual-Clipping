"""Launch centralized CIFAR-10 collection and plotting from tracked YAML configs."""
...
from experiments.cifar10.collect import build_parser as build_collect_parser, main as collect_main
from experiments.cifar10.plot import build_parser as build_plot_parser, main as plot_main
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Collect and plot centralized CIFAR-10 results from YAML configs.")
